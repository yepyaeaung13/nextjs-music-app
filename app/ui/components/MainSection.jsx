...
const MainSection = async () => {
  ...
  return (
    <main className="h-[100vh] md:overflow-hidden grid grid-cols-10">
      <section className="md:col-span-7 col-span-10 flex flex-col gap-1 bg-secondary">
        <div className="">
          <div className="w-full md:h-40 h-24 bg-gradient-to-r from-primary via-green-600 to-green-700 rounded-lg flex flex-col justify-center items-center">
            <h1 className="text-white text-3xl font-bold">Top 10 Songs</h1>
            <h2 className="text-xl font-bold">of the weekend</h2>
          </div>
        </div>
        <div className="px-2">
          <div className="top-ten-songs-list grid grid-cols-1 gap-1 text-sm md:px-8 px-2 md:py-5 py-2 h-96 overflow-y-scroll scrollbar border border-palette_one rounded-md">
      ...
      <aside className="h-[100vh] md:col-span-3 col-span-10 p-3 flex flex-col gap-2 bg-secondary">
